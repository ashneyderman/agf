...
- create `PromptTemplate` model in `agf/agent/models.py`. Add the following fields:
...
- rename `run` to `run_prompt` protocol function in `Agent` and replace prompt parameter with prompt_template: PromptTemplate
